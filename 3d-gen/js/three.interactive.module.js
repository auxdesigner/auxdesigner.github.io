import {
  Vector2,
  Raycaster,
} from "https://cdn.skypack.dev/pin/three@v0.133.1-nP52U8LARkTRhxRcba9x/mode=imports,min/optimized/three.js";
...
var InteractionManager = function InteractionManager(
  ...
  this.dispose = function () {
    ...
    if (_this.supportsPointerEvents) {
      _this.domElement.ownerDocument.removeEventListener(
        "pointermove",
  ...
  this.onTouchMove = function (touchEvent) {
    ...
    var event = new InteractiveEvent(
      _this.treatTouchEventsAsMouseEvents ? "mousemove" : "touchmove",
      touchEvent
    );
  ...
  this.onTouchStart = function (touchEvent) {
    ...
    var event = new InteractiveEvent(
      _this.treatTouchEventsAsMouseEvents ? "mousedown" : "touchstart",
      touchEvent
    );
  ...
  this.onTouchEnd = function (touchEvent) {
    ...
    var event = new InteractiveEvent(
      _this.treatTouchEventsAsMouseEvents ? "mouseup" : "touchend",
      touchEvent
    );
